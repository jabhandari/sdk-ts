...
1. Ensure the validity of the Offer with `Agent.parseCredentialOffer`
...
1. Create an AuthorizationRequest with `Agent.resolveCredentialOffer`
...
1. Retrieve the Credential with `Agent.resolveCredentialRequest`
